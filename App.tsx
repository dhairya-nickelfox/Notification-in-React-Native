...
const App = () => {
  ...
  const requestPermission = async () => {
    if (Platform.OS === 'android') {
      ...
      console.log(granted === PermissionsAndroid.RESULTS.GRANTED ? 'Notification Permission Granted' : 'Notification Permission Denied');
    }
  };
...
const styles = StyleSheet.create({
  ...
  image: { width: 150, height: 150, borderRadius: 75, borderWidth: 3, borderColor: '#ffffff' },
});
